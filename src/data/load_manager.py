...
class LoadManager:
    ...
    def load_information_part(self, point_id: int) -> List[InformationPart]:
        ...
        for extra_part in data:
            info_part = InformationPart(id=extra_part.get("id", 0),
                                        ...
                                        visitors_num=extra_part.get("visitors_num", 0),
    ...
    def load_excursions(self) -> Dict[str, Excursion]:
        ...
        for excursion_data in data:
            ...
            excursion = Excursion(
                ...
                visitors_num=excursion_data.get("visitors_num", 0),
            )
    ...
    def load_user_states(self) -> Dict[int, UserState]:
        ...
        for user_data in data:
            ...
            completed_excursions = user_data.get("completed_excursions", [])
            user_state = UserState(username=username, user_id=user_id, mode=mode, is_admin=is_admin,
                                   paid_excursions=paid_excursions, completed_excursions=completed_excursions)
    ...
    def save_information_part(self, information_part: InformationPart) -> None:
        ...
        if existing_part:
            self.information_parts_collection.replace_one({"id": information_part.get_id()}, information_part.to_dict())
        else:
    ...
    def delete_excursion(self, excursion_id: int) -> None:
        ...
        print(f"Deleted excursion with id {excursion_id} from MongoDB.")
